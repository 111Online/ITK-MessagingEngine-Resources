<?xml version="1.0"?>
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:n1="urn:hl7-org:v3" xmlns:npfitlc="NPFIT:HL7:Localisation" xmlns:n2="urn:hl7-org:v3/meta/voc" xmlns:voc="urn:hl7-org:v3/voc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:n3="urn:nhs-itk:ns:201005" xmlns:functx="http://www.functx.com" exclude-result-prefixes="n1 n2 n3 voc npfitlc xsi xs functx">
	...
	<xsl:variable name="title">
		<xsl:choose>
			<xsl:when test="/n3:POCDMT000002UK01ClinicalDocument/n1:title">
				<!--<xsl:value-of select="/n3:POCDMT000002UK01ClinicalDocument/n1:title"/>-->
				<xsl:value-of select="concat(/n3:POCDMT000002UK01ClinicalDocument/n1:title, ' - For Action')"/>
			</xsl:when>
			<xsl:otherwise>Clinical Document</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
	<xsl:param name="debug" select="'no'"/>
	<xsl:param name="p_doc" select="n3:POCDMT000002UK01ClinicalDocument"/>
	<xsl:template match="/">
		<xsl:apply-templates select="n3:POCDMT000002UK01ClinicalDocument"/>
	</xsl:template>
	<xsl:template match="n3:POCDMT000002UK01ClinicalDocument">
		<html>
			<head>
          ...
          Document. </xsl:comment>
			...
			<body>
				...
				<xsl:if test="/n3:POCDMT000002UK01ClinicalDocument/n1:informant/n1:relatedEntity/n1:relatedPerson/n1:name">
				...
				<xsl:if test="/n3:POCDMT000002UK01ClinicalDocument/n1:participant">
	...
	<xsl:template name="formatDate">
		...
		<xsl:if test="string-length($date)>8">
			<xsl:variable name="currentDateTime" select="current-dateTime()"/>
	  		<xsl:variable name="dateTimeAdjusted" as="xs:dateTime" select="functx:adjust-dateTime-to-uk-local-time($currentDateTime)"/>
			<xsl:text>, </xsl:text>
			<xsl:value-of select="format-dateTime($dateTimeAdjusted, '[H01]:[m01]')" />
		</xsl:if>
	</xsl:template>
	...
	<xsl:template name="patientBanner">
		<div id="patientBanner" class="banner">
			<table>
				<tbody>
					<tr>
						<xsl:if test="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:name">
							<td>
								<xsl:call-template name="cuiName">
									<xsl:with-param name="name" select="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:name"/>
								</xsl:call-template>
							</td>
						</xsl:if>
						<xsl:if test="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:birthTime">
							<td align="right">
								<span class="label"> Born </span>
								<xsl:call-template name="formatDate">
									<xsl:with-param name="date" select="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:birthTime/@value"/>
								</xsl:call-template>
							</td>
						</xsl:if>
						<xsl:if test="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:administrativeGenderCode">
							<td align="right">
								<span class="label"> Gender </span>
								<xsl:value-of select="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:patient/n1:administrativeGenderCode/@displayName"/>
							</td>
						</xsl:if>
						<td>
							<xsl:if test="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:id/@root='2.16.840.1.113883.2.1.4.1'">
								<!-- Verified NHS Number -->
								<span class="label"> NHS No. </span>
								<xsl:call-template name="cuiNHSNo">
									<xsl:with-param name="nhsNo" select="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:id[@root='2.16.840.1.113883.2.1.4.1']/@extension"/>
								</xsl:call-template>
								<br/>
							</xsl:if>
							<xsl:if test="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:id/@root='2.16.840.1.113883.2.1.3.2.4.18.23'">
								<!-- Unverified NHS Number -->
								<span class="label"> Unverified NHS No. </span>
								<xsl:call-template name="cuiNHSNo">
									<xsl:with-param name="nhsNo" select="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:id[@root='2.16.840.1.113883.2.1.3.2.4.18.23']/@extension"/>
								</xsl:call-template>
								<br/>
							</xsl:if>
							<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']">
								<!-- Local ID -->
								<span class="label"> Local Patient ID </span>
								<xsl:value-of select="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:id[@root='2.16.840.1.113883.2.1.3.2.4.18.24']/@extension"/>
								<br/>
							</xsl:for-each>
						</td>
					</tr>
			...
			<table class="header">
				<tbody>
					<tr>
						<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:addr">
							<td>
								<p class="label">
									<xsl:choose>
						...
						<td>
							<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:telecom">
								<span class="label">
									<xsl:choose>
						...
						<xsl:if test="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:providerOrganization">
							<td>
								<p class="label">
									<xsl:value-of select="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:providerOrganization/n1:standardIndustryClassCode/@displayName"/>
								</p>
								<p>
									<xsl:value-of select="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:providerOrganization/n1:name"/>
									<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:providerOrganization/n1:addr/n1:*">
										<br/>
										<xsl:value-of select="."/>
									</xsl:for-each>
								</p>
								<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:recordTarget/n1:patientRole/n1:providerOrganization/n1:telecom">
									<p>
										<span class="label">
											<xsl:choose>
												<xsl:when test="contains(@value, 'mailto')">Email </xsl:when>
	...
	<xsl:template name="informantBanner">
		<div id="informantBanner" class="banner">
						...
						<xsl:if test="/n3:POCDMT000002UK01ClinicalDocument/n1:informant/n1:relatedEntity/n1:relatedPerson/n1:name">
							...
							<td>
								<xsl:call-template name="getName">
									<xsl:with-param name="name" select="/n3:POCDMT000002UK01ClinicalDocument/n1:informant/n1:relatedEntity/n1:relatedPerson/n1:name"/>
								</xsl:call-template>
								<!--PRTR1 Get display name as well here-->
								<xsl:if test="/n3:POCDMT000002UK01ClinicalDocument/n1:informant/n1:relatedEntity/n1:code/@displayName">
									<xsl:text> - </xsl:text>
									<xsl:value-of select="/n3:POCDMT000002UK01ClinicalDocument/n1:informant/n1:relatedEntity/n1:code/@displayName"/>
								</xsl:if>								
							</td>
						</xsl:if>
					</tr>
			...
			<table class="header">
				<tbody>
					<tr>
						<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:informant/n1:relatedEntity/n1:addr">
							<td>
								<p class="label">
									<xsl:choose>
										<xsl:when test="@use='TMP'">Temporary Address</xsl:when>
						...
						<td>
							<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:informant/n1:relatedEntity/n1:telecom">
								<span class="label">
									<xsl:choose>
										<xsl:when test="@use='H'">Home </xsl:when>
										<xsl:when test="@use='HP'">Home </xsl:when>
		...
		<div class="header">
			<table class="header">
				<tr>
					...
					<td class="header">
						<xsl:call-template name="formatDate">
							<xsl:with-param name="date" select="/n3:POCDMT000002UK01ClinicalDocument/n1:effectiveTime/@value"/>
						</xsl:call-template>
					</td>
				</tr>
				<tr>
					...
					<td class="header">
						<xsl:value-of select="/n3:POCDMT000002UK01ClinicalDocument/n1:custodian/n1:assignedCustodian/n1:representedCustodianOrganization/n1:name"/>
					</td>
				</tr>
				<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:author">
					<tr>
						<th class="header">
				...
				<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:authenticator">
					<tr>
						<th class="header">
				...
				<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:dataEnterer">
					<tr>
						<th class="header">
				...
				<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:authorization">
	...
	<xsl:template name="titlebar">
		<div class="titlebar">
			<table class="titlebar">
				<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:componentOf">
					<xsl:if test="n1:encompassingEncounter">
						...
						<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:componentOf/n1:encompassingEncounter/n1:id">
							<xsl:choose>
				...
				<!--				<xsl:for-each select="//n3:POCDMT000002UK01ClinicalDocument/n1:participant[@typeCode='REFB']"> 
					<tr>
						<th class="titlebar">
							<xsl:text>Referrer</xsl:text>
						</th>
	...
	<xsl:template name="participantBanner">
		<div id="participantBanner" class="banner">
			...
			<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:participant[@typeCode='IND']">
				<table>
					<tr>
			...
			<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:participant[@typeCode='CON']">
				<table>
					<tr>
						<th class="participant">
							<xsl:text>Consultant</xsl:text>
			...
			<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:participant[@typeCode='REFT']">
				<table>
					<tr>
						<th class="participant">
			...
			<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:participant[@typeCode='BBY']">
				<table>
					<tr>
						<th class="participant">
			...
			<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:participant[@typeCode='REF']">
				<table>
					<tr>
						<th class="participant">
							<xsl:text>Referred By</xsl:text>
			...
			<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:participant[@typeCode='CALLBCK']">
				<table>
					<tr>
						<th class="participant">
			...
			<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:participant[@typeCode='DEV']">
				<table>
					<tr>
						<th class="participant">
			...
			<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:participant[@typeCode='DIST']">
				<table>
					<tr>
						<th class="participant">
			...
			<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:participant[@typeCode='ELOC']">
				<table>
					<tr>
						<th class="participant">
			...
			<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:participant[@typeCode='NOT']">
				<table>
					<tr>
						<th class="participant">
			...
			<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:participant[@typeCode='VIA']">
				<table>
					<tr>
						<th class="participant">
			...
			<xsl:for-each select="/n3:POCDMT000002UK01ClinicalDocument/n1:participant[@typeCode='WIT']">
				<table>
					<tr>
						<th class="participant">
		...
		<div class="footer">
			<table class="header">
				<tr>
					...
					<td class="header">
						<xsl:value-of select="/n3:POCDMT000002UK01ClinicalDocument/n1:id/@root"/>
					</td>
					<th class="header">
						<xsl:text>Version</xsl:text>
					</th>
					<td class="header">
						<xsl:value-of select="/n3:POCDMT000002UK01ClinicalDocument/n1:versionNumber/@value"/>
					</td>
				</tr>
				<!--PRTR1 get replacement of (related document) here-->
					<xsl:if test="/n3:POCDMT000002UK01ClinicalDocument/n1:relatedDocument/@typeCode='RPLC'">
						<tr>
							<th class="header">
								<xsl:text>Replacement of</xsl:text>
							</th>
							<td class="header">
								<xsl:value-of select="/n3:POCDMT000002UK01ClinicalDocument/n1:relatedDocument/n1:parentDocument/n1:id/@root"/>
							</td>
							<th class="header">
								<xsl:text>Version</xsl:text>
							</th>
							<td class="header">
								<xsl:value-of select="/n3:POCDMT000002UK01ClinicalDocument/n1:relatedDocument/n1:parentDocument/n1:versionNumber/@value"/>
							</td>
						</tr>	
					</xsl:if>
					<!--PRTR1 get addendum to (related document) here-->
					<xsl:if test="/n3:POCDMT000002UK01ClinicalDocument/n1:relatedDocument/@typeCode='APND'">
						<tr>
							<th class="header">
					...
					<xsl:if test="/n3:POCDMT000002UK01ClinicalDocument/n1:relatedDocument/@typeCode='XFRM'">
						<tr>
							<th class="header">
